...
$manifestPath = Join-Path $ArtifactsRoot "AvaGithubDesktop-$releaseVersion-release-manifest.json"
...
foreach ($rid in $RuntimeIdentifier) {
    ...
    $archiveName = "AvaGithubDesktop-$releaseVersion-$rid.zip"
