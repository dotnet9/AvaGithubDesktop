...
public partial class RebaseBranchWindow : CodeWFWindow
{
    ...
    public RebaseBranchWindow(RebaseBranchWindowViewModel viewModel)
        : this()
    {
    ...
    private void ViewModel_OnCloseRequested(
        object? sender,
        DialogCloseRequestedEventArgs<BranchRebaseRequest?> e)
    {
        Close(e.Result);
    }
}
