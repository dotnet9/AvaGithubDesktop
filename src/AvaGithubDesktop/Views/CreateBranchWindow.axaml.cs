...
public partial class CreateBranchWindow : CodeWFWindow
{
    ...
    public CreateBranchWindow(CreateBranchWindowViewModel viewModel)
        : this()
    {
    ...
    private void ViewModel_OnCloseRequested(
        object? sender,
        DialogCloseRequestedEventArgs<BranchCreationRequest?> e)
    {
        Close(e.Result);
    }
}
