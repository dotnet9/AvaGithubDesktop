...
public partial class RenameBranchWindow : CodeWFWindow
{
    ...
    public RenameBranchWindow(RenameBranchWindowViewModel viewModel)
        : this()
    {
    ...
    private void ViewModel_OnCloseRequested(
        object? sender,
        DialogCloseRequestedEventArgs<BranchRenameRequest?> e)
    {
        Close(e.Result);
    }
}
