...
- Help 菜单可打开更新日志、快捷键说明、日志目录和关于窗口。
...
- 常用菜单快捷键、GitHub Desktop 顶层菜单顺序、Edit 文本编辑菜单、无限高菜单弹层、`Ctrl+Enter` 快速提交、仓库/分支/Changes 过滤/提交摘要快捷聚焦、全屏切换、File 退出入口和 Help 快捷键说明窗口。
