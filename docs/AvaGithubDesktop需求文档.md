...
- Clone 仓库、创建新仓库、添加已有仓库的完整引导。
- 内置或托管 Git 运行时，减少对系统 Git 安装的依赖。
- 远端管理、默认分支管理和上游分支管理。
- 合并、变基、冲突处理的继续、跳过、终止流程。
- Commit amend、revert、cherry-pick、tag 等常用 Git 操作。
